    ...
    $('.contact-us form').submit(function () {
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json.nameMessage != '') {
                    $('.contact-us form .name').css('border-top', '1px solid #F85927');
                }
                if (json.emailMessage != '') {
                    $('.contact-us form .email').css('border-top', '1px solid #F85927');
                }
                if (json.messageMessage != '') {
                    $('.contact-us form textarea').css('border-top', '1px solid #F85927');
                }
